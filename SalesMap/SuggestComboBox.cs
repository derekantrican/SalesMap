...
namespace AutoCompleteComboBox
{
    public class SuggestComboBox : ComboBox
    {
        ...
        private Expression<Func<ObjectCollection, IEnumerable<Common.Region>>> _propertySelector;
        ...
        /// </summary>
        public Expression<Func<ObjectCollection, IEnumerable<Common.Region>>> PropertySelector
        {
